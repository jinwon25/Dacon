...
def main():
    ...
    state_v120 = PROJECT_DIR / "data/cache" / f"v120_{tag}_state.npz"
    ...
    pool_files = {
        "v94": PROJECT_DIR / "data/cache" / "v94_state.npz",
        "v97": PROJECT_DIR / "data/cache" / "v97_state.npz",
        "v97_cap1p5": PROJECT_DIR / "data/cache" / "v97_cap1p5_state.npz",
        "v104b": PROJECT_DIR / "data/cache" / "v104b_state.npz",
        "v107": PROJECT_DIR / "data/cache" / "v107_state.npz",
        "v108_15_15_08": PROJECT_DIR / "data/cache" / "v108_15_15_08_state.npz",
    }
    rows = []
    ...
    # save
    out_md = PROJECT_DIR / "docs/reports" / f"v120_{tag}_corr.md"
