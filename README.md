...
| [식음업장 메뉴 수요 예측 AI 온라인 해커톤](./식음업장%20메뉴%20수요%20예측%20AI%20온라인%20해커톤) | 연구 단계 | LB Private **0.6695** (가중 SMAPE, 낮을수록 좋음) · 로컬 0.585 제출대기 | 업장별 nz-mean 블렌드 — 0 제외 SMAPE 특성 활용. 베이스라인(0.694) 추월, LSTM·단일 GBDT는 열세 |
